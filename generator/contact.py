...
try:
    opts, args = getopt.getopt(sys.argv[1:], "nu:fu:", ["number of contacts", "file"])
...
testdata = [Contact(firstname=random_firstname(), middlename=random_short_middlename(), lastname=random_lastname(),
